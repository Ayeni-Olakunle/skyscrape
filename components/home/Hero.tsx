      ...
      <div className="relative max-w-7xl mx-auto px-6 py-28 flex flex-col md:flex-row items-center gap-8">
        <div className="md:w-1/2">
          ...
          <p className="text-gray-200 max-w-lg mb-6">
            At Caspira, we bring expertise, precision, and innovation to every
            project. From concept to completion, we build with integrity,
            efficiency, and excellence.
          </p>

          <div className="flex items-center gap-4">
            <a
              className="inline-flex items-center bg-yellow-500 text-black px-5 py-3 rounded-full font-medium shadow"
              href="#"
            >
              Explore Now
            </a>
