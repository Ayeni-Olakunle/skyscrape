  ...
  return (
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We specialize in managing all technical and operational aspects
              of facilities, ensuring systems operate efficiently and reliably.
              Our team delivers preventive maintenance, rapid response, and
              expert supervision.
            </p>
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        ...
        <button className="bg-yellow-500 hover:bg-yellow-600 px-8 py-4 rounded-lg font-semibold text-black transition">
          Contact Us
        </button>
